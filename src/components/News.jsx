...
const story2 = {
  ...
  imgURL: 'https://a57.foxnews.com/static.foxnews.com/foxnews.com/content/uploads/2021/11/1862/1048/Bari-Weiss.jpg?ve=1&tl=1',
...
const story5 = {
  title: 'NY COVID Case Rates, Hospital Admissions Plunge — But State Not Budging on Masks Yet',
  ...
  imgURL: 'https://media.nbcnewyork.com/2022/01/covid-positive-change.png?w=544',
  content: 'It\'s no secret why. COVID-19 hospitalizations are consistently trending down in New York, with the governor -- who identified that metric as most concerning to her when omicron-fueled cases started to skyrocket in December -- reporting a state total of 11,016 on Friday. That\'s down 12% from the omicron peak just 10 days ago.The share of new COVID positive hospital admissions in the densest regions downstate -- New York City, Long Island and Mid-Hudson, which also have the highest adult full vaccination rates per capita in the state -- declined by 20% at minimum over the last seven days, Hochul said. Those three regions are fueling the overall statewide decrease (-20.8%) on that metric over the last three weeks.',
  source: 'nbcny.com'
};
...
const story6 = {
  ...
  imgURL: 'https://www.kxan.com/wp-content/uploads/sites/40/2022/01/SchoolBusGettyImages-1216371553.jpg?w=876&h=493&crop=1',
  content: 'CENTRAL TEXAS (KXAN) — Staff shortages are leading to school closures across the state, as well as here in Central Texas, as the omicron variant continues to drive case counts up. Here are the upcoming school closures that have been announced in the Central Texas area so far.Lexington ISD Lexington ISD said all schools and offices would be closed Monday, Jan. 24 due to COVID-19. The district said during the closure, all classrooms and student areas will be deep cleaned and/or disinfected. ' ,
  source: 'kxan.com' 
};
      ...
      {stories.map(story => 
        <div className='news-story'>
          ...
          <div className='newsInfo'>
            ...
            <a style = {sourceStyles} href = {story.link}>{story.source}</a> 
          </div>
